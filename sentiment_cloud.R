...
data <- read.csv("2015-03-26 .csv")


# clean text
tweet_clean = clean.text(data$Posted.Content)
...
tweet_df$sentiment = rep(0, tweet_num)
for (i in 1:tweet_num)
{
  print(paste(i," of ", tweet_num))
  #put the datumbox api key in the quotes 
...
for (i in 1:nemo)
{
  ...
  emo_docs[i] = removeWords(emo.docs, stopwords("english"))
